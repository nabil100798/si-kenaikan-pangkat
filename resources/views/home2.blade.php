                                                ...
                                                <div class="item active">
                                                  <blockquote>
                                                    <div class="col-md-12">
                                                      ...
                                                      <div class="col-sm-9">
                                                        <p>Jangan tertipu oleh orang yang hanya pandai menguraikan Al – Quran. Uraian hanyalah kata kata. Lihatlah mereka yang mendasarkan perilaku pada Al – Quran. </p>
                                                        <small>Umar Ibnu al – Khattab</small>
                                                      </div>
                                                    </div>
                                                  </blockquote>
                                                </div>
                                                ...
                                                <div class="item">
                                                  <blockquote>
                                                    <div class="col-md-12">
                                                      ...
                                                      <div class="col-sm-9">
                                                        <p>Pengetahuan yang baik adalah yang memberi manfaat. Bukan yang hanya diingat. </p>
                                                        <small>Imam al – Syafi’i</small>
                                                      </div>
                                                    </div>
                                                  </blockquote>
                                                </div>
                                                ...
                                                <div class="item">
                                                  <blockquote>
                                                    <div class="row">
                                                      ...
                                                      <div class="col-sm-9">
                                                        <p>Jangan terlalu bergantung pada siapapun di dunia ini. Karena bayanganmu saja akan meninggalkanmu di saat gelap. </p>
                                                        <small>Ibnu Taymiyyah</small>
                                                      </div>
                                                    </div>
                                                  </blockquote>
                                                </div>
                            ...
                            <div class="col-md-12 padding-0">
                              <div class="panel box-v3">
                                ...
                                <div class="panel-body">
                                  ...
                                  <div class="media">
                                    ...
                                    <div class="media-body">
                                      <h5 class="media-heading">Document Report</h5>
                                  ...
                                  <div class="media">
                                    ...
                                    <div class="media-body">
                                      <h5 class="media-heading">Kegiatan</h5>
                                        <div class="progress progress-mini">
                                ...
                                <div class="panel-footer bg-white border-none">
                                    <center>
                                      <input type="button" value="Go" class="btn btn-danger box-shadow-none"/>
                                    </center>
                                </div>
                              </div>
                            </div>
